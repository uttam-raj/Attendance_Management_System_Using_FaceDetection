...
class Login:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"Images_GUI\login.jpg")
        ...
        lb1img1.place(x=700,y=195, width=80,height=80)

        get_str = Label(frame1,text="Login",font=("times new roman",20,"bold"),fg="#002B53",bg="#F2F2F2")
        get_str.place(x=140,y=100)

        #label1 
        username =lb1= Label(frame1,text="Username:",font=("times new roman",15,"bold"),fg="#002B53",bg="#F2F2F2")
        ...
        #label2 
        pwd =lb1= Label(frame1,text="Password:",font=("times new roman",15,"bold"),fg="#002B53",bg="#F2F2F2")
        ...
        loginbtn=Button(frame1,command=self.login,text="Login",font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="#fff",bg="#002B53",activeforeground="white",activebackground="#007ACC")
        loginbtn.place(x=33,y=310,width=270,height=35)


        # Creating Button Registration
        loginbtn=Button(frame1,command=self.reg,text="Register",font=("times new roman",13,"bold"),bd=0,relief=RIDGE,fg="#fff",bg="#002B53",activeforeground="white",activebackground="#007ACC")
        loginbtn.place(x=33,y=370,width=90,height=30)


        # Creating Button Forget
        loginbtn=Button(frame1,command=self.forget_pwd,text="Forget",font=("times new roman",13,"bold"),bd=0,relief=RIDGE,fg="#fff",bg="#002B53",activeforeground="white",activebackground="#007ACC")
        loginbtn.place(x=210,y=370,width=90,height=30)
        
        self.clock = Label(self.root, font = ("times",20,"bold"), bg = "#F2F2F2", relief = GROOVE)
        self.clock.place(x = 1120, y= 630)
        self.tick()
